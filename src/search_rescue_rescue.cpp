...
#define PAT_PATH_CSP_HOME_DIR homeDir + "/catkin_ws/src/3806ict_assignment_3/pat/return_home_rescue.csp"
...
int main(int argc, char *argv[])
{
	...
	if (!loadKnownWorld(PAT_WORLD_DIR, true_world)) {
	...
	if (!loadKnownWorld(PAT_WORLD_DIR, current_world)) {
		ROS_ERROR("Failed to import initial world for sub2");
		return EXIT_FAILURE;
	}
